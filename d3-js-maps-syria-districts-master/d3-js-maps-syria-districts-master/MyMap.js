var margin = {top: 10, left: 10, bottom: 10, right: 10},
    ...
    // syria_center = [-180, -89.99892578124998]; // Syria's geographical center
    syria_center = [0, 0]; // Syria's geographical center
...
var zoom = d3.behavior.zoom()
                      .translate([0, 0])
                      .scale(10)
                      .scaleExtent([10, 20]) // defines how far users can zoom in and out
                      .on("zoom", zoomed);
...
//Load TopoJSON data
d3.json("aruba.json", function(error, syr) {
